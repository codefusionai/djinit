# Contributing to djinit

Thanks for your interest in contributing to djinit!

## Setup

```bash
git clone https://github.com/prantoamt/djinit.git
cd djinit
pip install -e ".[dev]"
```
...
1. Add the template to `src/djinit/templates/common/` (or the appropriate platform directory).
...
- Maintain backwards compatibility with existing `.djinit.json` files.
